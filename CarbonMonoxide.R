library(readxl)
udara = read_excel("C:/praktikum/tes_akhir.xlsx", sheet = "nomor1")

CO = udara$CO
Tanpa_CO = udara$Tanpa_CO
d = CO-Tanpa_CO
dbar = mean(d)
...
#Cara otomatis
t.test(CO, Tanpa_CO, mu=mu0, paired=TRUE, alternative = c("two.sided","less","greater"), conf.level=0.95)